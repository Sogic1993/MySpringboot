...
<!--                 <p> -->
			<c:choose>
				<c:when test="${ requestScope.flag == -1 }">
                	<button id="returnbtn" class="btn btn-outline-secondary" onclick="returnEntry()">退貨申請</button><br>
				</c:when>
...
<!-- 						<br>退貨申請送出後將由系統代為通知賣家，後續流程由管理者端進行 -->
						...
						<button type="button" class="btn btn-primary btn-sm" onclick="swalbtn()">確認輸入無誤後，點此送出</button>
					</div>
<!--                 </p> -->
